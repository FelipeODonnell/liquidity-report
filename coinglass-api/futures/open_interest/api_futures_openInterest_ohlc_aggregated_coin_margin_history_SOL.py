...
url = "https://open-api-v4.coinglass.com/api/futures/open-interest/aggregated-coin-margin-history?exchange_list=Binance&symbol=SOL&interval=4h&limit=4500&start_time=1731436209918&end_time=1747071009918&unit=usd"
...
try:
    ...
    if response_data.get('code') == '0' and 'data' in response_data:
        ...
        base_filename = f"{base_filename}_SOL"
